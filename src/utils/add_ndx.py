...
def add_subcmd(subparsers):
    ...
    parser.add_argument(
        "-g", "--gro", required=True, type=str, help="Gro file (.gro)"
    )

    parser.add_argument(
        "-s", "--selection", type=str, help="Selection for new index group (MDtraj atom selection language)"
    )
    ...
    parser.add_argument(
        "-n", "--index", type=str, help="Input Index file"
    )
