...
# Add a postcmd for tleap when SS-bonds exist
# The tleap input of the top generated by packmol-memgen is not usable as is,
# so use the .parm7 produced by amb2gro instead
